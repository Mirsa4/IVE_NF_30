            ...
            if (isSaaS)
            {
                if (ApplicationServices.IsTouchClient)
                    ...
                    sb.AppendFormat(string.Format("$(\'<link></link>\').appendTo($(\'head\')).attr({{ href: \'{0}/App_Themes/MyCompany/_T" +
                                "heme_ModernRose.css?{0}\', type: \'text/css\', rel: \'stylesheet\' }});", ApplicationServices.Version), baseUrl);
                try
                {
                ...
                sb.AppendFormat("var __targetFramework=\'4.7.2\';__tf=4.0;__cothost=\'appfactory\';__appInfo=\'FORMULAR" +
                        "IO_IVE_NF_30|{0}\';", BusinessRules.JavaScriptString(context.User.Identity.Name));
